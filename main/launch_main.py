...
class GUI():
    ...
    def run(self):
        ...
        self.is_not_closed = ttk.Checkbutton(self.content, text="Predict ongoing day?", variable=self.boolean1,command=self.get_current_price)
        ...
        self.generate_button = ttk.Button(self.content, text="Generate",command= lambda: self.load_model(self.stock_input.get(),self.boolean2.get(),self.boolean1.get()))
